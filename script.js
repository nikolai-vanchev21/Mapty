...
class App {
  ...
  _showForm(mapE) {
    ...
    inputDistance.focus();
    this.formNewWorkoutVisible=true;
  }
  ...
  _renderWorkout(workout) {
    let html =` <li class="workout--container">
  ...
  _clickHandler(e) {
    const btnElemnt=e.target.closest('.workout__controls button');
    const workoutEl=e.target.closest('.workout');
    const editForm=e.target.closest('form.edit--workout');
    const formNewWorkout=e.target('form.new--workout');
    ...
    if(btnElement){
      if(btnElemnt.dataset.type==='edit')
      this._show
    }
  }
  ...
  _showWorkoutEditor(obj,el){
    const editor=el.closest('.workout--container').querySelector('.edit--workout');
